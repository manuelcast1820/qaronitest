                                            ...
                                            <tbody>
                                                <tr style="text-align: center;background: #FFF;">
                                                    ...
                                                    <td class="header-cell"
                                                        style="text-align: center;background: #002941;" valign="top">
                                                        <img src="{{ url('/img/logoqaroni.svg') }}" alt="logo"
                                                            width="100px" />
                                                    </td>
                                                </tr>
                                                <tr>
                                                    <td class="body-cell" valign="top">
                                                        <table style="height: 362px; width: 100%;" width="100%"
                                                            cellspacing="0" cellpadding="0" bgcolor="#ffffff">
                                                            <tbody>
                                                                <tr style="height: 66px;">
                                                                    <td style="padding-bottom: 20px; background-color: #ffffff; height: 66px;"
                                                                        valign="top">
                                                                        <p><strong>HOLA,
                                                                                {{ $email }}</strong></p>

                                                                        <p> Gracias por tu compra, te recordamos la
                                                                            reservacion que acabas de realizar: </p>
                                                                        <p><strong>Slug: </strong>{{ $event->slug }}</p>
                                                                        <p><strong>Fecha: </strong>{{ \Carbon\Carbon::parse($event->date)->format('j F, Y') }}</p>
                                                                        <p><strong>Cantidad: </strong>{{ $quantity }}</p>

                                                                        <p style="margin-top: 5px;">Pincha el botón para
                                                                            acceder a la plataforma <a
                                                                                href="{{ url('/') }}">www.qaroni.test</a>
                                                                        </p>
                                                ...
                                                <tr>
                                                    <td class="footer-cell" valign="top">qaronievents
                                                        <br />Qaroni derechos reservados
                                                    </td>
                                                </tr>
                                            </tbody>
                                        </table>
